...
通过为结构的和成员指定适当的值，将项定义为回调项 `pszText` `iImage` `LVITEM` (请参阅 [CListCtrl：： GetItem](reference/clistctrl-class.md#getitem)) 。 如果应用程序维护项或子项的文本，请指定该成员的 **LPSTR_TEXTCALLBACK** 值 `pszText` 。 如果应用程序跟踪项的图标，请指定该成员的 **I_IMAGECALLBACK** 值 `iImage` 。
