---
description: 了解更多： MFC ActiveX 控件：优化
...
|-------------------------------------------------------|------------|----------------------|
|**可见时激活** "复选框|清除|[关闭 "在可见时激活" 选项](turning-off-the-activate-when-visible-option.md)|
...
|"**无闪烁激活**" 复选框|Select|[提供 Flicker-Free 激活](providing-flicker-free-activation.md)|
...
- [提供 Flicker-Free 激活](providing-flicker-free-activation.md)
