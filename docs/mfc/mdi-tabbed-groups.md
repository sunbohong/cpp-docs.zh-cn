...
ms.locfileid: "97280763"
---
# <a name="mdi-tabbed-groups"></a>MDI 选项卡式组

多文档界面 (MDI) 选项卡式组功能支持多文档界面 (MDI) 应用程序以显示一个或多个选项卡式窗口 (或选项卡式窗口的组（在 MDI 客户端区域中称为 *选项卡式组* ）。 选项卡式窗口可垂直对齐或水平对齐。 如果应用程序承载多个 MDI 选项卡式组，则将用拆分器分隔这些组。
