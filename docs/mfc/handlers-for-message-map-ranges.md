---
description: 了解详细信息： Message-Map 范围的处理程序
title: 消息映射范围的处理程序
ms.date: 11/04/2016
helpviewer_keywords:
...
## <a name="writing-the-message-map-entry"></a><a name="_core_writing_the_message.2d.map_entry"></a> 写入 Message-Map 条目
