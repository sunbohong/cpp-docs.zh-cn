---
description: 了解有关以下方面的详细信息： MFC 中的文件
title: MFC 中的文件
ms.date: 11/04/2016
helpviewer_keywords:
...
ms.locfileid: "97155041"
---
# <a name="files-in-mfc"></a>MFC 中的文件

在 Microsoft 基础类库 (MFC) ，类 [CFile](reference/cfile-class.md) 处理正常文件 i/o 操作。 此系列文章介绍如何打开和关闭文件以及如何读取数据并将数据写入文件。 还讨论了文件状态操作。 有关如何使用 MFC 的基于对象的序列化功能作为在文件中读取和写入数据的另一种方法的说明，请参阅文章 [序列化](serialization-in-mfc.md)。
