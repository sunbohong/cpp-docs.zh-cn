...
ms.locfileid: "97203076"
---
# <a name="methods-of-creating-a-toolbar"></a>创建工具栏的方法

MFC 提供了两个用于创建工具栏的类： [CToolBar](reference/ctoolbar-class.md) 和 [CToolBarCtrl](reference/ctoolbarctrl-class.md) (包装 Windows 公共控件 API) 。 `CToolBar` 提供 toolbar 公共控件的所有功能，并为您处理许多必需的公共控件设置和结构。但是，生成的可执行文件通常会大于使用创建的 `CToolBarCtrl` 。
