---
description: 了解更多相关信息：管理菜单、控件条和快捷键
title: 管理菜单、控件条和快捷键
ms.date: 11/04/2016
helpviewer_keywords:
...
框架窗口使用 [如何更新 User-Interface 对象](how-to-update-user-interface-objects.md)中所述的 ON_UPDATE_COMMAND_UI 机制参与更新用户界面项。 空循环期间，工具栏上的按钮和其他控件栏会进行更新。 菜单栏上的下拉菜单中的菜单项正好在菜单下拉之前进行更新。
