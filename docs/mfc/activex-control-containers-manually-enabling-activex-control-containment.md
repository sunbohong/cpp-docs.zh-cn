---
description: 了解有关以下内容的详细信息： ActiveX 控件容器：手动启用 ActiveX 控件包含
...
- 修改主对话框的 `InitInstance` 函数 (在容器中找到。由 MFC 应用程序向导调用 [AfxEnableControlContainer](reference/ole-initialization.md#afxenablecontrolcontainer)的) CPP，如以下示例中所示：
