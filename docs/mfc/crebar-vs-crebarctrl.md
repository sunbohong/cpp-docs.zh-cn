---
description: 了解详细信息： CReBar 和 CReBarCtrl
...
ms.locfileid: "97309428"
---
# <a name="crebar-vs-crebarctrl"></a>CReBar 与CReBarCtrl

MFC 提供了两个用于创建 rebar： [CReBar](reference/crebar-class.md) 和 [CReBarCtrl](reference/crebarctrl-class.md) (的类，这些类用于包装 Windows 公共控件 API) 。 `CReBar` 提供 rebar 公共控件的所有功能，并为你处理许多必需的公共控件设置和结构。
