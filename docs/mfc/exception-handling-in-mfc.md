...
无论是直接使用 c + + 异常还是使用 MFC 异常宏，都将使用[](reference/cexception-class.md) `CException` 可能由框架或应用程序引发的 CException 类或派生对象。
...
- [异常：版本3.0 中对异常宏的更改](exceptions-changes-to-exception-macros-in-version-3-0.md)
