---
description: 了解详细信息： CMFCPropertyGridFontProperty 类
...
中应用于在单击 "属性值" 下拉按钮时显示的 "字体" 对话框的样式。 默认值是 CF_EFFECTS 和 CF_SCREENFONTS 的按位组合 (或) 。 有关详细信息，请参阅 [CHOOSEFONT 结构](/windows/win32/api/commdlg/ns-commdlg-choosefontw)的 *Flags* 参数。
...
下面的示例演示如何构造类的对象 `CMFCPropertyGridFontProperty` 。 此示例是 [新控件示例](../../overview/visual-cpp-samples.md)的一部分。
