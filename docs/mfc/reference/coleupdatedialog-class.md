---
description: 了解详细信息： COleUpdateDialog 类
...
|“属性”|描述|
|----------|-----------------|
|[COleUpdateDialog：:D oModal](#domodal)|在更新模式下显示 " **编辑链接** " 对话框。|
...
此函数仅构造 `COleUpdateDialog` 对象。 若要显示该对话框，请调用 [DoModal](../../mfc/reference/colelinksdialog-class.md#domodal)。 `COleLinksDialog`如果只想更新现有的链接或嵌入项，则应使用此类，而不是。
