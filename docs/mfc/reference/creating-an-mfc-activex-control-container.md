---
description: 了解有关以下内容的详细信息：创建 MFC ActiveX 控件容器
...
ms.locfileid: "97343187"
---
# <a name="creating-an-mfc-activex-control-container"></a>创建 MFC ActiveX 控件容器

ActiveX 控件容器是一种父程序，它提供 ActiveX (以前的 OLE) 控件的运行环境。 你可以创建一个能够包含带有或不带 MFC 的 ActiveX 控件的应用程序，但使用 MFC 更为简单。
