---
description: 了解详细信息： CPropExchange 类
...
|“属性”|描述|
|----------|-----------------|
|[CPropExchange::ExchangeBlobProp](#exchangeblobprop)|交换 (BLOB) 属性的二进制大型对象。|
...
*ppUnk*<br/>
指向一个变量的指针，该变量包含指向属性的 `IUnknown` 接口的指针 (此变量通常是类) 的成员。
