...
使用 DDX_DHtml_Img_Src 宏检索 IMAGE 元素的 Src 属性时，Internet Explorer 图像对象将返回图像源的完全转义 URL。 例如，如果使用 DDX_DHtml_Img_Src 宏将 IMAGE 元素的 Src 属性设置为 "一些有趣的图片"，则在检索该属性时，Internet Explorer 将返回字符串 "res://d:\myapplication\myapp.exe/some%20interesting%20picture."
