---
description: 了解详细信息： CMFCReBar 类
title: CMFCReBar 类
ms.date: 11/04/2016
f1_keywords:
- CMFCReBar
...
|[CMFCReBar：： OnToolHitTest](#ontoolhittest)| (将重写 [CWnd：： OnToolHitTest](../../mfc/reference/cwnd-class.md#ontoolhittest)。 ) |
...
*dwStyle*<br/>
中包含要应用于带区的样式。 有关带区样式的完整列表，请参阅 `fStyle` Windows SDK 文档的 [REBARBANDINFO](/windows/win32/api/commctrl/ns-commctrl-rebarbandinfow) 结构中的说明。
...
提供对 `CReBarCtrl` 对象的基础公共控件的直接访问 `CMFCReBar` 。
