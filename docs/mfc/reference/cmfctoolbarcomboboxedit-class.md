---
description: 了解详细信息： CMFCToolBarComboBoxEdit 类
...
从类派生一个类 `CMFCToolBarComboBoxEdit` ，以自定义其编辑操作。
...
下面的示例演示如何构造类的对象 `CMFCToolBarComboBoxEdit` 。 此代码片段是 [IE 演示示例](../../overview/visual-cpp-samples.md)的一部分。
