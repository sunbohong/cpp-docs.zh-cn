---
description: 了解详细信息： CMFCRibbonLinkCtrl 类
...
下面的示例演示如何使用类的构造函数 `CMFCRibbonLinkCtrl` 。 此代码片段是 [功能区小工具示例](../../overview/visual-cpp-samples.md)的一部分。
...
使用与对象关联的超链接打开网页 `CMFCRibbonLinkCtrl` 。
