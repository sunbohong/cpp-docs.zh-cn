---
description: 了解详细信息： COleStreamFile 类
...
|[COleStreamFile：:D etach](#detach)|解除流与对象的的阻止。|
|[COleStreamFile：： System.resources.resourcemanager.getstream](#getstream)|返回当前流。|
...
将提供的 OLE 流与对象相关联 `COleStreamFile` 。
...
*lpStream*<br/>
指向 OLE 流 (要 `IStream` 与对象关联的) 。 不能为 NULL。
...
指向 ( [IStream](/windows/win32/api/objidl/nn-objidl-istream)) 的当前流接口的指针。
