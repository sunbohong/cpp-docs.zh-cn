...
例如，按 `AfxParseURL` 如下方式分析窗体 *Service://server/dir/dir/object.ext:port* 的 url 并返回存储的组件：
...
*strUsername*<br/>
对 `CString` 包含用户名称的对象的引用。

*strPassword*<br/>
对 `CString` 包含用户密码的对象的引用。
