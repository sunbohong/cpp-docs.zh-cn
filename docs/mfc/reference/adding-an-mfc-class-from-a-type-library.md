...
1. 在 " [添加类](../../ide/adding-a-class-visual-cpp.md#add-class-dialog-box) " 对话框的 "模板" 窗格中，单击 " **类型库中的 MFC 类**"，然后单击 " **打开** " 以显示 " [从 typelib 添加类" 向导](../../mfc/reference/add-class-from-typelib-wizard.md)。
