---
description: 了解详细信息： CD2DRectF 类
title: CD2DRectF 类
ms.date: 11/04/2016
f1_keywords:
- CD2DRectF
...
|“属性”|描述|
|----------|-----------------|
|[CD2DRectF：： CD2DRectF](#cd2drectf)|已重载。 `CD2DRectF`从对象构造对象 `D2D1_RECT_F` 。|

### <a name="public-methods"></a>公共方法

|“属性”|描述|
|----------|-----------------|
|[CD2DRectF：： IsNull](#isnull)|返回一个 **布尔** 值，该值指示表达式是否不包含有效的数据 (NULL) 。|
