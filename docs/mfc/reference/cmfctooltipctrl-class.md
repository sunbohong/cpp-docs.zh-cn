---
description: 了解详细信息： CMFCToolTipCtrl 类
...
`CMFCToolTipCtrl` `CMFCToolTipInfo` 在应用程序中将、和[CTooltipManager 类](../../mfc/reference/ctooltipmanager-class.md)对象一起使用，以实现自定义的工具提示。
...
3. 使用 [CTooltipManager：： SetTooltipParams](../../mfc/reference/ctooltipmanager-class.md#settooltipparams) 方法，通过使用对象中定义的样式为应用程序中的所有工具提示设置视觉样式 `CMFCToolTipInfo` ：
...
只要显示工具提示，就会使用 *pParams* 指定的颜色和视觉样式来绘制工具提示。 *PParams* 的值存储在受保护的成员中 `m_Params` ，此派生类可以通过重写 [CMFCToolTipCtrl：： OnDrawBorder](#ondrawborder)、 [CMFCToolTipCtrl：： OnDrawIcon](#ondrawicon)、 [CMFCToolTipCtrl：： OnDrawLabel](#ondrawlabel)、 [CMFCToolTipCtrl：： OnDrawSeparator](#ondrawseparator)或 [CMFCToolTipCtrl：： OnFillBackground](#onfillbackground)的派生类来访问该成员以维护指定的外观。
