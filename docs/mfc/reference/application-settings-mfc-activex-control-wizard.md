---
description: 了解详细信息：应用程序设置，MFC ActiveX 控件向导
...
- **生成帮助文件**
   ...
   选择此选项来生成存根的帮助文件，并配置该项目为控件包含帮助。 默认情况下，在不使用此选项的情况下创建的项目将仅生成用户右键单击控件时显示的 " **关于** " 框，使用 F1，或在控件的容器上单击 " **帮助** "。
...
[MFC ActiveX 控件向导的控件设置](../../mfc/reference/control-settings-mfc-activex-control-wizard.md)
