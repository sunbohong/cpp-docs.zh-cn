---
description: 了解有关以下内容的详细信息：用于 OLE 控件的对话框数据交换函数
...
|[DDX_OCFloat](#ddx_ocfloat)|管理 **`float`** **`double`** OLE 控件的属性和 **`float`** (或 **`double`**) 数据成员之间 (或) 数据的传输。|
|[DDX_OCFloatRO](#ddx_ocfloatro)|管理 **`float`** **`double`** OLE 控件的只读属性与 **`float`** (或) 数据成员之间 (或) 数据的传输 **`double`** 。|
|[DDX_OCInt](#ddx_ocint)|管理 **`int`** **`long`** OLE 控件的属性和 **`int`** (或 **`long`**) 数据成员之间 (或) 数据的传输。|
|[DDX_OCIntRO](#ddx_ocintro)|管理 **`int`** **`long`** OLE 控件的只读属性与 **`int`** (或) 数据成员之间 (或) 数据的传输 **`long`** 。|
...
`DDX_OCFloat`函数管理 **`float`** **`double`** 对话框、窗体视图或控件视图对象中 OLE 控件的属性与 **`float`** **`double`** 对话框、窗体视图或控件视图对象的 (或) 数据成员之间 (或) 数据的传输。
...
`DDX_OCFloatRO`函数管理 **`float`** **`double`** 对话框、窗体视图或控件视图对象中 OLE 控件的只读属性与 **`float`** **`double`** 对话框、窗体视图或控件视图对象的 (或) 数据成员之间的 (或) 数据的传输。
...
`DDX_OCInt`函数管理 **`int`** **`long`** 对话框、窗体视图或控件视图对象中 OLE 控件的属性与 **`int`** **`long`** 对话框、窗体视图或控件视图对象的 (或) 数据成员之间 (或) 数据的传输。
...
`DDX_OCIntRO`函数管理 **`int`** **`long`** 对话框、窗体视图或控件视图对象中 OLE 控件的只读属性与 **`int`** **`long`** 对话框、窗体视图或控件视图对象的 (或) 数据成员之间的 (或) 数据的传输。
