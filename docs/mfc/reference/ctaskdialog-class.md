...
如果显示了， [ENSURE](diagnostic-services.md#ensure) `CTaskDialog` 或输入参数为 NULL，则此方法将引发异常，并显示 "确保宏"。
...
此方法引发异常，如果已[ENSURE](diagnostic-services.md#ensure) `CTaskDialog` 显示并且具有天棚式进度栏，则使用确保宏。
