...
扩展了 [CFrameWnd 类](../../mfc/reference/cframewnd-class.md)的功能，Windows 多文档界面 (MDI) 框架窗口。
...
[CMFCHeaderCtrl 类](../../mfc/reference/cmfcheaderctrl-class.md)<br/>
支持对标头控件的多个列进行排序。
...
表示任务窗格控件任务的帮助器类 ([CMFCTasksPane 类](../../mfc/reference/cmfctaskspane-class.md)) 。 任务对象表示任务组 ([CMFCTasksPaneTaskGroup 类](../../mfc/reference/cmfctaskspanetaskgroup-class.md)) 中的项。 每个任务可具有在用户单击任务和显示在任务名称左侧的图标时框架所执行的命令。
...
扩展 [CPaneFrameWnd 类](../../mfc/reference/cpaneframewnd-class.md)。 它可支持多个窗格。 不是控件条的单个嵌入句柄，而是 `CMultiPaneFrameWnd` 包含 [CPaneContainerManager 类](../../mfc/reference/cpanecontainermanager-class.md) 对象，该对象使用户能够将一个停靠 `CMultiPaneFrameWnd` 到另一个，并动态创建多个浮动的选项卡式窗口。
...
[CSettingsStore 类](../../mfc/reference/csettingsstore-class.md)<br/>
...
简化了在使用 MFC 文档/视图体系结构的应用程序中 ([CTabView 类](../../mfc/reference/ctabview-class.md)) 的选项卡控件类的使用。
...
运行外部应用程序的菜单项。 "**自定义**" 对话框中的 "**工具**" 选项卡 ([CMFCToolBarsCustomizeDialog 类](../../mfc/reference/cmfctoolbarscustomizedialog-class.md)) 使用户能够添加用户工具，并为每个用户工具指定名称、命令、参数和初始目录。
