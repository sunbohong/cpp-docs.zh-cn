---
description: 了解详细信息： CDaoWorkspace 类
...
*lpszLocale*<br/>
用于指定创建 *lpszDestName* 的排序顺序的字符串表达式。 如果通过接受下面)  (的默认值来省略此参数 `dbLangGeneral` ，则新数据库的区域设置与旧数据库的区域设置相同。 可能的值为：
