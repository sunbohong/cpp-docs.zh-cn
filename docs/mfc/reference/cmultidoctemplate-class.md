---
description: 了解详细信息： CMultiDocTemplate 类
...
- 视图类，用于显示上面列出的文档类中的数据。 可以从 [CView](../../mfc/reference/cview-class.md)、、或派生此 `CScrollView` 类 `CFormView` `CEditView` 。  (你也可以 `CEditView` 直接使用。 ) 
