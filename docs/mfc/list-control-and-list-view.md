...
`CListView` 使用 MFC 文档/视图体系结构，可以轻松地将列表控件与 MFC 文档/视图体系结构相集成，并将控件封装为 [CEditView](reference/ceditview-class.md) 封装编辑控件：控件填充 MFC 视图的整个表面区域。  (视图为控件， *并* 将其强制转换为 `CListView` 。 ) 
