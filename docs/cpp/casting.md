...
![类 C，具有子&#45;对象 B 和 A](../cpp/media/vc38zz2.gif "类 C，具有子&#45;对象 B 和 A") <br/>
具有子对象 B 和 A 的类 C
...
对于非多态类型的转换，可以使用 [static_cast](../cpp/static-cast-operator.md) 运算符 (本主题说明静态和动态强制转换之间的差异，以及何时适合使用每个) 。
