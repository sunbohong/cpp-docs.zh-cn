...
> **`__declspec(restrict)`***pointer_return_type* *函数* ( # A1;
...
对于适用于函数中的别名的另一个批注，请参阅 [__declspec (noalias) ](../cpp/noalias.md)。

有关 **`restrict`** C++ AMP 中包含的关键字的信息，请参阅 [限制 (C++ AMP)](../cpp/restrict-cpp-amp.md)。
