...
**Visual Studio 2017 版本15.3 及更高版本** (随 [/std 提供： c + + 17](../build/reference/std-specify-language-standard-version.md)) ：后缀或前缀递增或递减运算符的操作数的类型不能为 **`bool`** 。 换而言之，假设有一个 `b` 类型为的变量 **`bool`** ，则不再允许使用这些表达式：
