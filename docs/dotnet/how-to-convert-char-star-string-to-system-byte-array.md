---
description: 了解有关详细信息，请参阅如何：将 char * 字符串转换为 System：： Byte 数组
...
ms.locfileid: "97304358"
---
# <a name="how-to-convert-char--string-to-systembyte-array"></a>如何：将 char \* 字符串转换为 System：： Byte 数组

将字符串转换为数组最有效的方法 `char *` <xref:System.Byte> 是使用 <xref:System.Runtime.InteropServices.Marshal> 类。
