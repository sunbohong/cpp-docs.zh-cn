...
ms.locfileid: "97147701"
---
# <a name="introduction-to-atl"></a>ATL 简介

ATL 是活动模板库，这是一组基于模板的 c + + 类，您可以轻松地创建 (COM) 对象的小型、快速组件对象模型。 它对关键 COM 功能有特殊支持，包括： [IUnknown](/windows/win32/api/unknwn/nn-unknwn-iunknown)、 [IClassFactory](/windows/win32/api/unknwnbase/nn-unknwnbase-iclassfactory)、 [IClassFactory2](/windows/win32/api/ocidl/nn-ocidl-iclassfactory2)和、双重接口的常用实现、 `IDispatch` 标准 COM 枚举器接口、连接点、脱离接口以及 ActiveX 控件。
