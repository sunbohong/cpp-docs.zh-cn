---
description: 了解详细信息： Catldllmodulet 用作基类类
...
|[Catldllmodulet 用作基类：:D llMain](#dllmain)|动态链接库中的可选入口点 (DLL) 。|
...
`CAtlDllModuleT` 表示动态链接库的模块 (DLL) 并提供所有 DLL 项目使用的函数。 [CAtlModuleT](../../atl/reference/catlmodulet-class.md)类的这一特殊化包括对注册的支持。
