...
|名称|描述|
|----------|-----------------|
|[CAtlFile：： m_pTM](#m_ptm)|指向对象的指针 `CAtlTransactionManager`|
...
*dwShareMode*<br/>
共享模式。 请参阅中的 *dwShareMode* `CreateFile` 。

*dwCreationDisposition*<br/>
创建处置。 请参阅中的 *dwCreationDisposition* `CreateFile` 。

*dwFlagsAndAttributes*<br/>
标志和特性。 请参阅中的 *dwFlagsAndAttributes* `CreateFile` 。

*lpsa*<br/>
安全特性。 请参阅中的 *lpSecurityAttributes* `CreateFile` 。

*hTemplateFile*<br/>
模板文件。 请参阅中的 *hTemplateFile* `CreateFile` 。
...
传输的字节数。 请参阅中的 *lpNumberOfBytesTransferred* `GetOverlappedResult` 。

*bWait*<br/>
Wait 选项。 请参阅中的 *bWait* `GetOverlappedResult` 。
