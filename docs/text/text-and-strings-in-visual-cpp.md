---
description: 了解详细信息： Visual C++ 中的文本和字符串
...
[支持 (MBCS 的多字节字符集) ](../text/support-for-multibyte-character-sets-mbcss.md)<br/>
讨论 MBCS，它是一种替代 Unicode 的替代方法，用于支持无法用单字节表示的字符集，如日语和中文。

[Tchar 中的一般文本映射](../text/generic-text-mappings-in-tchar-h.md)<br/>
