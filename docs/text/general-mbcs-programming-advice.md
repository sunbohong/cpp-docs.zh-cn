---
description: 了解详细信息：常规 MBCS 编程建议
title: 常规 MBCS 编程建议
ms.date: 11/04/2016
helpviewer_keywords:
...
ms.locfileid: "97187528"
---
# <a name="general-mbcs-programming-advice"></a>常规 MBCS 编程建议

使用以下提示：

- 出于灵活性，请尽可能使用运行时宏（如 `_tcschr` 和） `_tcscpy` 。 有关详细信息，请参阅 [tchar 中的一般文本映射](../text/generic-text-mappings-in-tchar-h.md)。
...
- 设计对话框时，允许在静态文本控件末尾留出约30% 的额外空间用于 MBCS 转换。
