...
|“属性”|说明|
|----------|-----------------|
|[get_tile_extent](#tiled_index__get_tile_extent)|返回一个[extent](extent-class.md)具有 `tiled_index` 模板参数 `_Dim0` 、和的值的范围对象 `_Dim1` `_Dim2` 。|
...
|名称|说明|
|----------|-----------------|
|[tile_extent](#tile_extent)|获取一个[extent](extent-class.md)包含 `tiled_index` 模板参数 `tiled_index` 模板参数 `_Dim0` 、 `_Dim1` 和的值的范围对象 `_Dim2` 。|
...
返回一个[extent](extent-class.md)具有 `tiled_index` 模板参数 `_Dim0` 、和的值的范围对象 `_Dim1` `_Dim2` 。
...
获取一个[extent](extent-class.md)包含 `tiled_index` 模板参数 `tiled_index` 模板参数 `_Dim0` 、 `_Dim1` 和的值的范围对象 `_Dim2` 。
