---
description: 了解详细信息：演练：使用任务和 XML HTTP 请求进行连接
...
[快速入门：使用 XML HTTP 请求进行连接 (IXMLHTTPRequest2) ](/previous-versions/windows/apps/hh770550\(v=win.10\)) 
