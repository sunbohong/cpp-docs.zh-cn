---
description: 了解详细信息： multi_link_registry 类
...
|[remove](#remove)|从对象中删除链接 `multi_link_registry` 。  (重写 [network_link_registry：： remove](network-link-registry-class.md#remove)。 ) |
