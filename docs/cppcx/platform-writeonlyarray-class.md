---
description: 了解详细信息： Platform：： WriteOnlyArray 类
...
|[WriteOnlyArray：:D ata](#data)|指向数据缓冲区的指针。|
...
## <a name="writeonlyarraybegin-method"></a><a name="begin"></a> WriteOnlyArray：： begin 方法
...
## <a name="writeonlyarraydata-property"></a><a name="data"></a> WriteOnlyArray：:D ata 属性
...
## <a name="writeonlyarrayend-method"></a><a name="end"></a> WriteOnlyArray：： end 方法
...
## <a name="writeonlyarrayfastpass-property"></a><a name="fastpass"></a> WriteOnlyArray：： FastPass 属性
...
## <a name="writeonlyarrayget-method"></a><a name="get"></a> WriteOnlyArray：： get 方法
...
## <a name="writeonlyarraylength-property"></a><a name="length"></a> WriteOnlyArray：： Length 属性
...
## <a name="writeonlyarrayset-function"></a><a name="set"></a> WriteOnlyArray：： set 函数
