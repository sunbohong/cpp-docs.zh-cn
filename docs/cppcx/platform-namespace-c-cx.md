...
|[Platform：:D 委托类](../cppcx/platform-delegate-class.md)|表示回调函数的签名。|
|[Platform：:D isconnectedException 类](../cppcx/platform-disconnectedexception-class.md)|该对象已与其客户端断开连接。|
|[Platform：： Exception 类](../cppcx/platform-exception-class.md)|表示在应用程序执行期间出现的错误。 异常的基类。|
...
[Platform：： Runtime：： System.runtime.compilerservices 命名空间](../cppcx/platform-runtime-compilerservices-namespace.md)<br/>
