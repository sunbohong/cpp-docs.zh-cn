---
description: '了解详细信息：变量参数列表 ( 的 )  (c + +/CLI) '
title: 变量自变量列表 (...) (C++/CLI)
ms.date: 10/12/2018
ms.topic: reference
helpviewer_keywords:
...
> [!NOTE]
> 本主题是关于 C++/CLI。 有关 `...` 在 ISO 标准 c + + 中使用的信息，请参阅 [省略号和可变参数模板](../cpp/ellipses-and-variadic-templates.md) 以及 [后缀表达式](../cpp/postfix-expressions.md)中的省略号和默认参数。
