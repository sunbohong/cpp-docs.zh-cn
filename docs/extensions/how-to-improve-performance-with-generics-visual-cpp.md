---
description: '了解有关详细信息，请参阅如何：通过泛型 (c + +/CLI 提高性能) '
...
## <a name="example-two-main-drawbacks-of-net-framework-collections"></a>示例： .NET Framework 集合的两大主要缺点
...
## <a name="example-benefit-of-using-generic-collection"></a>示例：使用泛型集合的好处
