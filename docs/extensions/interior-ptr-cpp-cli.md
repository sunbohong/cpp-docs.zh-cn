---
description: '了解有关以下方面的详细信息： interior_ptr (c + +/CLI) '
...
- [如何：在 c + +/CLI (声明和使用内部指针和托管数组) ](how-to-declare-and-use-interior-pointers-and-managed-arrays-cpp-cli.md)

- [如何：在 c + +/CLI (用 interior_ptr 关键字声明值类型) ](how-to-declare-value-types-with-the-interior-ptr-keyword-cpp-cli.md)

- [如何：在 c + +/CLI (用内部指针和本机指针重载函数) ](how-to-overload-functions-with-interior-pointers-and-native-pointers-cpp-cli.md)

- [如何：在 c + +/CLI (用 const 关键字声明内部指针) ](how-to-declare-interior-pointers-with-the-const-keyword-cpp-cli.md)
