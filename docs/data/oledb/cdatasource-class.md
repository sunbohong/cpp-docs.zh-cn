---
description: 了解详细信息： CDataSource 类
title: CDataSource 类
ms.date: 11/04/2016
f1_keywords:
- ATL.CDataSource
...
|[打开](#open)|使用 `CLSID` 、 `ProgID` 或 `CEnumerator` 调用方提供的名字对象 (数据源) 创建与提供程序的连接。|
...
有关)  ( 的数据链接文件的详细信息，请参阅 Windows SDK 中的 [数据链接 API 概述](/previous-versions/windows/desktop/ms718102(v=vs.85)) 。
