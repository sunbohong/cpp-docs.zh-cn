---
description: '了解详细信息：记录集：体系结构 (ODBC) '
title: 记录集：体系结构 (ODBC)
ms.date: 11/04/2016
helpviewer_keywords:
...
> [!NOTE]
> 参数的顺序很重要。 有关参数的信息和有关参数的详细信息，请参阅 [记录集： (ODBC) 参数化记录集 ](../../data/odbc/recordset-parameterizing-a-recordset-odbc.md)。
