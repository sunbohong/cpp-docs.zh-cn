---
description: 了解详细信息：在窗体中显示和操作数据
title: 在窗体中显示和操作数据
ms.date: 11/04/2016
helpviewer_keywords:
...
您可以使用 "MFC 应用程序向导" 或 " **添加类** " (如 [添加 MFC ODBC 使用者](../../mfc/reference/adding-an-mfc-odbc-consumer.md)) 中所述，同时创建视图类及其关联的记录集类。
