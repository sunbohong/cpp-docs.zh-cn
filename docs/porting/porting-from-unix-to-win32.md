---
description: 了解详细信息：在 Windows 上运行 Linux 程序
...
- 在本地计算机或 Azure 上，在 Linux 虚拟机或 Docker 容器中运行程序。 有关详细信息，请参阅[虚拟机](https://azure.microsoft.com/services/virtual-machines/)和[ Azure 上的 Docker](/azure/docker/)。
