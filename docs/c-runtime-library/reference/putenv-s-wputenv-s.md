---
description: 了解详细信息： _putenv_s、_wputenv_s
...
*varname* 是要添加或修改的环境变量的名称， *value_string* 是变量的值。 如果 *varname* 已是环境的一部分，则其值将替换为 *value_string*;否则，新的 *varname* 变量及其 *value_string* 将添加到环境中。 您可以通过将空字符串指定为 ") *value_string* 的 (，从环境中删除变量。
