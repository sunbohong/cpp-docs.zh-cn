---
description: 了解详细信息： strtok_s、_strtok_s_l、wcstok_s、_wcstok_s_l、_mbstok_s、_mbstok_s_l
...
|TCHAR.H 例程|\_\_未定义 UNICODE & MBCS|\_定义 MBCS|已定义 _UNICODE|
|---------------------|------------------------------------|--------------------|-----------------------|
