---
description: 了解详细信息： _CrtMemCheckpoint
...
ms.locfileid: "97319672"
---
# <a name="_crtmemcheckpoint"></a>_CrtMemCheckpoint

获取调试堆的当前状态并将其存储在应用程序提供的 **_CrtMemState** 结构中 (仅) 调试版本。
...
应用程序必须将指针传递到在 Crtdbg.h 中定义的、在 *state* 参数中定义的 **_CrtMemState** 结构的以前分配的实例。 如果 **_CrtMemCheckpoint** 在检查点创建期间遇到错误，该函数将生成一个描述此问题的 **_CRT_WARN** 调试报告。
