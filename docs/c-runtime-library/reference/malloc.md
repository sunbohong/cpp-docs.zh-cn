...
:::row:::
   :::column span="":::
      [calloc](calloc.md)\
      [_exec 函数](../../c-runtime-library/exec-wexec-functions.md)\
   ...
   :::column span="":::
      ...
      [获取](../../c-runtime-library/gets-getws.md)
   :::column-end:::
   :::column span="":::
      [_getw](getw.md)\
   ...
   :::column span="":::
      ...
      [setvbuf](setvbuf.md)\
      [_spawn 函数](../../c-runtime-library/spawn-wspawn-functions.md)\
      [_strdup](strdup-wcsdup-mbsdup.md)\
      [主板](system-wsystem.md)\
