...
如果文件大小已成功更改， **_chsize_s** 返回值0。 非零返回值指示错误：如果指定的文件是只读的，则返回值为 **EACCES** ; 如果指定的文件是只读的或描述符无效 **，则为** ENOSPC; 如果设备上没有剩余空间，则返回 ; 如果 Size 小于零，则返回 **EINVAL** 。 **errno** 设置为相同的值。
