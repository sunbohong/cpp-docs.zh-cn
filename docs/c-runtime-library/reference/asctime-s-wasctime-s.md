---
description: 了解详细信息： asctime_s、_wasctime_s
...
**Asctime** 函数将存储为结构的时间转换为字符串。 *TmSource* 值通常是通过调用 **gmtime** 或 **localtime** 获取的。 这两个函数可用于填充 **tm** 结构，如时间 .h 所定义。
