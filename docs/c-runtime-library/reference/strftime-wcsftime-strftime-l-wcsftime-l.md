...
|**% u**|ISO 8601 weekday 作为十进制数字 (1-7;星期一为 1) |
|**% U**|每年的第几周作为小数 (00-53) ，其中第一个星期日是第1周的第一天|
|**% V**|ISO 8601 周数值作为 (00-53) 的十进制数|
|**% w**|以十进制数字 (0-6;星期日为 0) |
|**% W**|每年的第几周作为小数 (00-53) ，其中第一个星期一是第1周的第一天|
|**% x**|区域设置的日期表示形式|
|**% X**|区域设置的时间表示形式|
|**% y**|不带世纪的年份，如十进制数 (00-99) |
|**% Y**|以十进制数字表示的带有世纪数的年份|
