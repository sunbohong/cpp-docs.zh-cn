---
title: _fileno
description: _Fileno 的 API 参考;这会获取与流关联的文件描述符。
ms.date: 4/2/2020
api_name:
- _fileno
- _o__fileno
...
> [!NOTE]
> 如果 **stdout** 或 **stderr** 不与输出流相关联 (例如，在没有控制台窗口的 Windows 应用程序中) ，则返回的文件描述符为-2。 在早期版本中，返回的文件说明符为 -1。 此更改使应用程序得以将此情况与错误区分开来。
