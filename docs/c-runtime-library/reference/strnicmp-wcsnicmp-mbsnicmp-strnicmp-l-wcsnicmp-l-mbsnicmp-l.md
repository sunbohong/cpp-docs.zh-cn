---
description: 了解详细信息： _strnicmp、_wcsnicmp、_mbsnicmp、_strnicmp_l、_wcsnicmp_l、_mbsnicmp_l
...
参数验证错误时，这些函数将返回 **_NLSCMPERROR**，这是在和中定义的 \<string.h> \<mbstring.h> 。
