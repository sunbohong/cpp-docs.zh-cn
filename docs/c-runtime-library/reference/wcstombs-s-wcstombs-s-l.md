---
description: 了解详细信息： wcstombs_s、_wcstombs_s_l
...
如果 **wcstombs_s** 成功转换源字符串，则会将转换后的字符串的大小（以字节为单位）放入 *&#42;pReturnValue* (提供的 *pReturnValue* 不是 **null**) 。 即使 *mbstr* 参数为 **NULL** ，并且提供了一种方法来确定所需的缓冲区大小，也会发生这种情况。 请注意，如果 *mbstr* 为 **NULL**，则忽略 *count* 。
