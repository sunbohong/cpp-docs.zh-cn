---
description: 了解详细信息： _splitpath、_wsplitpath
...
完整路径的每个组件均存储在单独的缓冲区中;清单常量在 STDLIB.H 中定义 **_MAX_DRIVE**、 **_MAX_DIR**、 **_MAX_FNAME** 和 (**_MAX_EXT** 。H) 指定每个文件组件的最大大小。 文件组件大于相应清单常量会导致堆损坏。
