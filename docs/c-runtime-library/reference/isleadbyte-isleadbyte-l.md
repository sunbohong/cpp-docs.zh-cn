---
description: 了解详细信息： isleadbyte、_isleadbyte_l
...
如果 **isleadbyte** 宏的参数是多字节字符的第一个字节，则它返回非零值。 对于从-1 (**EOF**) 到 **UCHAR_MAX** (0xff) （含）的任何整数参数， **isleadbyte** 将产生有意义的结果。
