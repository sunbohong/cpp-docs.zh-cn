---
description: 了解详细信息： _stricmp、_wcsicmp、_mbsicmp、_stricmp_l、_wcsicmp_l、_mbsicmp_l
...
出现错误时， **_mbsicmp** 返回在和中定义的 _NLSCMPERROR \<string.h> \<mbstring.h> 。
