---
description: 了解详细信息： _findfirst、_findfirst32、_findfirst32i64、_findfirst64、_findfirst64i32、_findfirsti64、_wfindfirst、_wfindfirst32、_wfindfirst32i64、_wfindfirst64、_wfindfirst64i32、_wfindfirsti64
...
完成 **_findfirst** 或 [_findnext](findnext-functions.md)函数 (或) 的任何变体后，必须调用 [_findclose](findclose.md) 。 这将释放应用程序中这些函数所使用的资源。
