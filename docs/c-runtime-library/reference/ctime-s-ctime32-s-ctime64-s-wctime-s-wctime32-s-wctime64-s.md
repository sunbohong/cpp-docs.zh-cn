---
description: 了解详细信息： ctime_s、_ctime32_s、_ctime64_s、_wctime_s、_wctime32_s、_wctime64_s
...
**Ctime_s** 函数将作为 [time_t](../../c-runtime-library/standard-types.md)结构存储的时间值转换为字符串。 *SourceTime* 值通常是从对 [time](time-time32-time64.md)的调用中获取的，它返回自 00:00:00) 年1月 1970 1 日午夜 (（协调世界时） (UTC) 之前经过的秒数。 返回值字符串正好包含 26 个字符，且格式为：
