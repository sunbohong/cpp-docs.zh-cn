---
description: 了解详细信息： strncpy、_strncpy_l、wcsncpy、_wcsncpy_l、_mbsncpy _mbsncpy_l
...
下面的示例演示如何使用 **strncpy** ，以及如何使用它来导致程序 bug 和安全问题。 编译器会为对 **strncpy** 的每个调用生成一个警告，这与 **crt_strncpy_x86 (15) ： warning C4996： ' Strncpy '：此函数或变量可能不安全。请考虑改用 strncpy_s。若要禁用弃用，请使用 _CRT_SECURE_NO_WARNINGS。有关详细信息，请参阅联机帮助。**
