---
description: 了解详细信息： _dupenv_s_dbg、_wdupenv_s_dbg
...
**_Dupenv_s_dbg** 和 **_wdupenv_s_dbg** 函数与 **_dupenv_s** 和 **_wdupenv_s** 相同，不同之处在于，定义 **_DEBUG** 时，这些函数将使用 [malloc](malloc.md) [_malloc_dbg](malloc-dbg.md)的调试版本为环境变量的值分配内存。 有关 **_malloc_dbg** 的调试功能的信息，请参阅 [_malloc_dbg](malloc-dbg.md)。
