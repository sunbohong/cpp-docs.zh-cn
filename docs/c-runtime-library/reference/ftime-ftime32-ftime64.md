---
description: 了解详细信息： _ftime、_ftime32 _ftime64
...
**_Ftime** 函数获取当前的本地时间，并将其存储在 *timeptr* 所指向的结构中。 **_Timeb**、 **__timeb32** 和 **__timeb64** 结构是在中定义的 \<sys\\timeb.h> 。 它们包含下表中列出的四个字段。
