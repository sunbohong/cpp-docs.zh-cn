---
description: 了解详细信息： _getdcwd、_wgetdcwd
...
如果指定的驱动器不可用，或者驱动器的类型 (例如，无法确定可移动的、固定的、cd-rom、RAM 磁盘或网络驱动器) ，则会调用无效的参数处理程序。 有关详细信息，请参阅[参数验证](../../c-runtime-library/parameter-validation.md)。
