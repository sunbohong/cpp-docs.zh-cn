---
description: 了解详细信息： _strtime_s、_wstrtime_s
...
|指向有效缓冲区 (Not **NULL**) |0|**EINVAL**|未修改|
|指向有效缓冲区 (Not **NULL**) |0 < 大小 < 9|**EINVAL**|空字符串|
|指向有效缓冲区 (Not **NULL**) |大小 > 9|0|注解中指定的当前时间格式|
