...
|变量|描述|
|--------------|-----------------|
|[__argc、 \_ _argv \_ _wargv](../c-runtime-library/argc-argv-wargv.md)|包含命令行自变量。|
...
|[errno、_doserrno、_sys_errlist 和 _sys_nerr](../c-runtime-library/errno-doserrno-sys-errlist-and-sys-nerr.md)|已弃用。 请改为使用 `_get_errno`、`_set_errno`、`_get_doserrno`、`_set_doserrno`、`perror` 和 `strerror`。<br /><br /> 存储错误代码和相关信息。|
