---
description: 了解详细信息： packaged_task 类
...
|[packaged_task：： operator ( # B1 ](#op_call)|调用存储在关联异步状态中的可调用对象，以原子方式存储返回值，并将状态设置为 " *就绪*"。|
...
## <a name="packaged_taskoperator"></a><a name="op_call"></a> packaged_task：： operator ( # A1
