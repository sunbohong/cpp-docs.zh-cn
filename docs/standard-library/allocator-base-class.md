...
*同步*\
分配器的同步策略有 [sync_none 类](sync-none-class.md)、[sync_per_container 类](sync-per-container-class.md)、[sync_per_thread 类](sync-per-thread-class.md)或 [sync_shared 类](sync-shared-class.md)。
