---
description: 了解详细信息：演练：使用安装项目部署 Visual C++ 应用程序
...
1. 在菜单栏上，选择  >    >  "文件" "新建 **项目**" 以打开 "**新建项目**" 对话框。 然后，在对话框的左窗格中，展开 "**已安装** 的  >  **其他项目类型**" 节点，然后选择 " **Visual Studio 安装程序**"。 在中间窗格中，选择“安装项目”。
