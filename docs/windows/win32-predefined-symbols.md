...
|IDD_ABOUTBOX| (对话框) 产品 "对话框|
|IDI_PROJECTNAME|) 当前项目 "图标 (图标|
|IDI_SMALL|) 当前项目小图标 (图标|
|IDIGNORE|与对话框上的 "忽略" 按钮一起使用 (控件) |
|IDM_ABOUT| (菜单项) 用于帮助 .。。关于 .。。|
|IDM_EXIT| (菜单项) 用于文件 .。。退出 .。。|
|IDNO| (控件) 对话框，无按钮|
|IDOK| (控制) "对话框中的" 确定 "按钮|
...
[ATL 预定义符号](../windows/atl-predefined-symbols.md)<br/>
