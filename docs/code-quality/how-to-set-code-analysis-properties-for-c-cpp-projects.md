---
description: 了解详细信息：如何：设置 C/c + + 项目的代码分析属性
...
在 CMake 项目中，更改中的和键的值， `enableMicrosoftCodeAnalysis` `enableClangTidyCodeAnalysis` `CMakeSettings.json` 以启用或禁用代码分析。 有关详细信息，请参阅 [在 Visual Studio 中使用 Clang-Tidy](../code-quality/clang-tidy.md) 。
