---
description: 了解详细信息： C26449 NO_SPAN_FROM_TEMPORARY
title: C26449
ms.date: 03/22/2018
ms.topic: reference
f1_keywords:
...
ms.locfileid: "97258611"
---
# <a name="c26449-no_span_from_temporary"></a>C26449 NO_SPAN_FROM_TEMPORARY

`gsl::span``std::string_view`当临时的无效时，或从临时创建的会无效。

C++ Core Guidelines： [GSL： Views](https://github.com/isocpp/CppCoreGuidelines/blob/master/CppCoreGuidelines.md#gslview-views)。
