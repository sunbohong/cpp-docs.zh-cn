...
下面的代码将生成此警告，因为向函数传递了 null DACL `SetSecurityDescriptorDacl` ：
...
若要查看有关如何创建安全描述符的完整示例，请参阅 [使用 c + + 创建新对象的安全描述符](/windows/desktop/SecAuthZ/creating-a-security-descriptor-for-a-new-object-in-c--)。 有关详细信息，请参阅 [创建 DACL](/windows/desktop/SecBP/creating-a-dacl)。
