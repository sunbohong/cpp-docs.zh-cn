...
- 为了减少警告数，代码分析只检测所有者指针的此模式。 因此，首先需要正确标记所有者。 如果我们接收到客户提供的 [反馈](https://developercommunity.visualstudio.com/spaces/62/index.html) 以支持此类方案，则可以轻松地将此扩展为涵盖原始指针。
