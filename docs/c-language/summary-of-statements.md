---
title: C 语句摘要
description: Microsoft C 实现中的语句语法摘要。
ms.date: 08/24/2020
...
ms.locfileid: "88898393"
---
# <a name="summary-of-c-statements"></a>C 语句摘要
...
&emsp; *`try-except-statement`*  /\* Microsoft 专用 \*/<br/>
&emsp; *`try-finally-statement`*  /\* Microsoft 专用 \*/
...
&emsp; **`__leave ;`**  /\* Microsoft 专用<sup>1</sup> \*/
...
1 `__leave` 关键字仅在 `try-except-statement` 或 `try-finally-statement` 的 `__try` 块中有效。
