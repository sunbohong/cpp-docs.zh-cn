---
title: 声明摘要
description: 了解由 Microsoft C/C++ 编译器实现的声明的标准 C 语法。
ms.date: 10/30/2020
...
<sup>2</sup> 有关这些元素的详细信息，请参阅 [`__asm`](../assembler/inline/asm.md)、[`__clrcall`](../cpp/clrcall.md)、[`__stdcall`](../cpp/stdcall.md)、[`__based`](../cpp/based-grammar.md)、[`__fastcall`](../cpp/fastcall.md)、[`__thiscall`](../cpp/thiscall.md)、[`__cdecl`](../cpp/cdecl.md)、[`__inline`](../cpp/inline-functions-cpp.md) 和 [`__vectorcall`](../cpp/vectorcall.md)。
<sup>3</sup> 此样式已过时。
