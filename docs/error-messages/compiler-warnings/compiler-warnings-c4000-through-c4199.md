...
|[编译器警告（等级 4）C4019](compiler-warning-level-4-c4019.md)|全局范围内的空语句|
...
|[编译器警告（等级 1）C4067](../../error-messages/compiler-warnings/compiler-warning-level-1-c4067.md)|预处理器指令后有意外标记-应输入换行符|
