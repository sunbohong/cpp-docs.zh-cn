...
|[编译器错误 C2723](compiler-error-c2723.md)|"*function*"： "*说明符*" 说明符在函数定义上非法|
|[编译器错误 C2724](compiler-error-c2724.md)|"*function*"： "static" 不应在文件范围内定义的成员函数上使用|
|[编译器错误 C2725](compiler-error-c2725.md)|"*type*"：无法通过值或引用引发或捕获托管/WinRT 对象|
|[编译器错误 C2726](compiler-error-c2726.md)|"gcnew" 只能用于创建具有托管/WinRT 类型的对象|
|编译器错误 C2727|已过时。|
|[编译器错误 C2728](compiler-error-c2728.md)|"*type*"：本机数组不能包含此类型|
|编译器错误 C2729|已过时。|
|[编译器错误 C2730](compiler-error-c2730.md)|"*class*"：不能是自身的基类|
|[编译器错误 C2731](compiler-error-c2731.md)|"*function*"：无法重载函数|
|[编译器错误 C2732](compiler-error-c2732.md)|链接规范与 "*function*" 的早期规范冲突|
|[编译器错误 C2733](compiler-error-c2733.md)|"*function*"：不允许重载函数的第二个 C 链接|
|[编译器错误 C2734](compiler-error-c2734.md)|"*identifier*"：如果不是 "extern"，则必须初始化 "const" 对象|
|[编译器错误 C2735](compiler-error-c2735.md)|不允许在形参类型说明符中使用 "*关键字*" 关键字|
|[编译器错误 C2736](compiler-error-c2736.md)|不允许在强制转换中使用 "*关键字*" 关键字|
|编译器错误 C2737|"*identifier*"：必须初始化 "constexpr" 对象|
|[编译器错误 C2738](compiler-error-c2738.md)|"operator *type*"：不明确或者不是 "*class*" 的成员|
|[编译器错误 C2739](compiler-error-c2739.md)|"*number*"：显式托管/WinRT 数组维度必须介于1到32之间|
|编译器错误 C2740|操作数 "*number*" 的值超出了 "*lower_bound*  -  *upper_bound*" 范围|
|编译器错误 C2741|帧大小太大|
|编译器错误 C2742|已过时。|
|[编译器错误 C2743](compiler-error-c2743.md)|"*type*"：无法使用 __clrcall 析构函数或复制构造函数捕捉本机类型|
|编译器错误 C2744|"*operator*" 不是有效的 CLR/WinRT 运算符|
|[编译器错误 C2745](compiler-error-c2745.md)|"*token*"：此标记不能转换为标识符|
|编译器错误 C2746|已过时。|
|编译器错误 C2747|已过时。|
|[编译器错误 C2748](compiler-error-c2748.md)|创建的托管/WinRT 数组必须具有数组大小或数组初始值设定项|
|[编译器错误 C2749](compiler-error-c2749.md)|"*type*"：使用/clr： safe 只能引发或捕获托管类的句柄|
|[编译器错误 C2750](compiler-error-c2750.md)|"*type*"：不能对引用类型使用 "new";改为使用 "gcnew"|
|[编译器错误 C2751](compiler-error-c2751.md)|"*parameter*"：无法限定函数参数的名称|
|[编译器错误 C2752](compiler-error-c2752.md)|"*template*"：多个部分专用化与模板参数列表匹配|
|[编译器错误 C2753](compiler-error-c2753.md)|"*template*"：部分专用化无法与主模板的参数列表匹配|
|[编译器错误 C2754](compiler-error-c2754.md)|"*template*"：部分专用化不能有依赖的非类型模板参数|
|[编译器错误 C2755](compiler-error-c2755.md)|"*parameter*"：部分专用化的非类型参数必须是简单标识符|
|[编译器错误 C2756](compiler-error-c2756.md)|"*template*"：部分专用化中不允许使用默认模板参数|
|[编译器错误 C2757](compiler-error-c2757.md)|"*identifier*"：具有此名称的符号已存在，因此不能将此名称用作命名空间名称|
|[编译器错误 C2758](compiler-error-c2758.md)|"*member*"：必须初始化引用类型的成员|
|编译器错误 C2759|内联汇编程序报表： *error_message*|
|[编译器错误 C2760](compiler-error-c2760.md)|语法错误：应为 "*token1*" 而不是 "*token2*"|
...
|[编译器错误 C2774](compiler-error-c2774.md)|"*identifier*"：没有 "put" 方法与该属性关联|
...
|[编译器错误 C2786](compiler-error-c2786.md)|"*type*"： __uuidof 的操作数无效|
|[编译器错误 C2787](compiler-error-c2787.md)|"*identifier*"：没有与此对象关联的 GUID|
|[编译器错误 C2788](compiler-error-c2788.md)|"*identifier*"：多个与此对象关联的 GUID|
|编译器错误 C2789|"*identifier*"：必须初始化常量限定类型的对象|
|[编译器错误 C2790](compiler-error-c2790.md)|"super"：该关键字只能在类成员函数体内使用|
|[编译器错误 C2791](compiler-error-c2791.md)|非法使用 "super"： "*class*" 没有任何基类|
|[编译器错误 C2792](compiler-error-c2792.md)|"super"：该关键字后面必须跟 "：："|
|[编译器错误 C2793](compiler-error-c2793.md)|"*token*"： "：：" 后面有意外标记，应输入标识符或关键字 "operator"|
