...
ms.locfileid: "97244857"
---
# <a name="compiler-error-c3797"></a>编译器错误 C3797

"override"：事件声明不能具有重写说明符 (应将该说明符放在事件的 add/remove/raise 方法上) 

不能重写事件 (事件，而无需显式定义的访问器方法与另一个常用事件) 。 重写事件必须定义其对访问器函数的行为。
