---
description: 了解更多： C 运行时错误 R6030
title: C 运行时错误 R6030
ms.date: 11/04/2016
f1_keywords:
- R6030
...
在其他程序使用代码注入技术捕获某些 DLL 库调用时也可能会出现此错误。 一些侵入安全程序使用此方法。 在 Visual Studio 2015 之前的 Visual C++ 版本中，可以使用静态链接的 CRT 库解决该问题，但出于安全和应用程序更新的原因，不建议这样做。 更正此问题可能需要最终用户操作。
