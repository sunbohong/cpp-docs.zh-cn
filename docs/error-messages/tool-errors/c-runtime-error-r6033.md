---
description: 了解更多： C 运行时错误 R6033
title: C 运行时错误 R6033
ms.date: 11/04/2016
f1_keywords:
- R6033
...
此诊断指示在加载程序锁定过程中正在执行 MSIL 指令。 如果已通过使用/clr 标志编译了本机 c + +，则会发生这种情况。 仅对包含托管代码的模块使用/clr 标志。 有关详细信息，请参阅 [混合程序集的初始化](../../dotnet/initialization-of-mixed-assemblies.md)。
