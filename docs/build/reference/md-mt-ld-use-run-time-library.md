---
description: '详细了解：/MD、/MT、/LD (使用 Run-Time 库) '
title: '/MD、-MT、-LD (使用 Run-Time 库) '
ms.date: 07/17/2019
f1_keywords:
- /ld
- /mt
...
有关如何使用运行时库的调试版本的详细信息，请参阅 [C Run-Time 库参考](../../c-runtime-library/c-run-time-library-reference.md)。
