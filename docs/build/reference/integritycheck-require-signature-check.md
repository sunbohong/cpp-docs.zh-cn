---
description: '了解详细信息：/INTEGRITYCHECK (需要签名检查) '
...
1. 在 " **其他选项**" 中，输入 `/INTEGRITYCHECK` 或 `/INTEGRITYCHECK:NO` 。

## <a name="see-also"></a>请参阅

[MSVC 链接器参考](linking.md)<br/>
[MSVC 链接器选项](linker-options.md)<br/>
[可移植可执行文件 (PE) 文件的强制完整性签名](https://social.technet.microsoft.com/wiki/contents/articles/255.forced-integrity-signing-of-portable-executable-pe-files.aspx)<br/>
