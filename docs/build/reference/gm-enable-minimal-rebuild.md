---
description: '了解详细信息：/Gm (启用最小重新生成) '
title: /Gm（启用最小重新生成）
ms.date: 11/12/2018
f1_keywords:
...
由于增量链接器不支持通过使用 [/ZW (Windows 运行时编译)](zw-windows-runtime-compilation.md) 选项来支持 .obj 文件中包含的 Windows 元数据，因此 **/Gm** 选项与 **/ZW** 不兼容。
