...
以下任何参数均可指定给 **/GENPROFILE** 或 **/FASTGENPROFILE**。 此处列出的由管道 () 字符分隔的参数 **|** 是互斥的。 使用逗号 (**，**) 字符分隔选项。
...
[/LTCG () 的链接时间代码生成 ](ltcg-link-time-code-generation.md)<br/>
